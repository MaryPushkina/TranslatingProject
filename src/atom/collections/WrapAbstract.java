 ...
 */
public abstract class WrapAbstract<TOriginal, TImplementataion> implements IWrap<TOriginal, TImplementataion>
{
    protected TOriginal _Original;
    protected TImplementataion _Implementation;
    
 
    public WrapAbstract(TOriginal original, TImplementataion implementation)
    {
        _Original = original;
